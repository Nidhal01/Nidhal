            ...
            <div class="row">
                        ...
                        <div class="cart-page-heading mb-30">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="firstName" id="first_name" value="<?php if (isset($_SESSION['id'])) {echo $_SESSION['firstName'] ; }?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="last_name">Last Name <span>*</span></label>
                                    <input type="text" class="form-control" name="lastName" id="last_name" value="<?php if (isset($_SESSION['id'])) {echo $_SESSION['lastName'] ; }?>" required>
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="country">Country <span>*</span></label>
                                    <select  name="country" multiple size="8" class="w-100" id="country">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control mb-3"  name="add" id="street_address" value="">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="postcode">Postcode <span>*</span></label>
                                    <input type="text" class="form-control" name="code" id="postcode" value="">
                                </div>
                                <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="phone" id="phone_number" min="0" value="<?php if (isset($_SESSION['id'])) {echo $_SESSION['phone'] ; }?>">
                                </div>
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                    <div class="order-details-confirmation">
                        ...
                        <input type="submit" class="btn essence-btn" name="submit" value="Place Order">
                    </div>
                </div>
            </div>
        </div>
